...
public class FitnessAppAPIContext(DbContextOptions<FitnessAppAPIContext> options) : IdentityDbContext<User>(options)
{
    ...
    public DbSet<MuscleGroupExercise> MuscleGroupExercises { get; init; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MuscleGroupExercise>()
               .HasOne<MuscleGroup>()
               .WithMany()
